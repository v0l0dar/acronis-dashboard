...
| 17  | `SearchBar` — debounce + XSS sanitization         | 1h         | 0.75h    | -0.25h    | Manual 300 ms `setTimeout`/`clearTimeout` debounce in `SearchBar.vue` and `FilterPanel.vue`; no external package |
